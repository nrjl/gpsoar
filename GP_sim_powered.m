...
% addpath 'C:\Documents and Settings\n.lawrance\My Documents\Nick\Wing
% Model\graphics\'
...
% --- Aircraft parameters --- %
Cd0		= 0.00;		% Parasitic drag coefficient !! POWERED !!
S		= 0.95677;		% Wing reference area
AR		= 1e4;		% Wing aspect ratio
b		= 4.32;			% Wing span
...
for jj = 1:100
	num = sprintf('%3.0f',jj);
	num(strfind(num, ' ')) = '0';
	filename = sprintf('Data\\JGCD_Data\\%s_Save%s.mat', sdate, num);
