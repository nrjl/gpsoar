function [V, uvw_wind, v_earth, alfa, beta, Eks, Eps, Et] = plot_states2(X, U, tx, tu, m, modetimes, col, ls)
%--------------------------------------------------------------------------
%
% FUNCTION:		plot_states2
%
% PURPOSE:		Plot states2
%
% SYNTAX:		plot_states2(X, U, tx, tu, m, modetimes, col, ls)
%
...
t0 = tx(1); tf = tx(end);
main_line_colour = [255 20 0]./255;
mode_line_colour = [255 128 0]./255;
if nargin == 6
	col = [0 0 1];
	ls = '-';
end
...
plot(tx, uvw_wind(1,:), 'linestyle', ls, 'color', col);
plot_vertical(modetimes(:,2:end), ls, mode_line_colour);
plot_vertical(modetimes(:,1), ls, main_line_colour, 2);
set(gca, 'Xlim', [t0, tf]);
...
subplot(3,1,2);
if (~oplot); cla; end; hold on;
plot(tx, uvw_wind(2,:), 'linestyle', ls, 'color', col);
plot_vertical(modetimes(:,2:end), ls, mode_line_colour);
plot_vertical(modetimes(:,1), ls, main_line_colour, 2);
set(gca, 'Xlim', [t0, tf]);
xlabel('Time (s)', 'FontSize', fsize);
...
subplot(3,1,3);
if (~oplot); cla; end; hold on;
plot(tx, uvw_wind(3,:), 'linestyle', ls, 'color', col);
plot_vertical(modetimes(:,2:end), ls, mode_line_colour);
plot_vertical(modetimes(:,1), ls, main_line_colour, 2);
set(gca, 'Xlim', [t0, tf]);
xlabel('Time (s)', 'FontSize', fsize);
...
subplot(2,1,1);
if (~oplot); cla; end; hold on;
plot(tx, V, 'linestyle', ls, 'color', col);
plot_vertical(modetimes(:,2:end), ls, mode_line_colour);
plot_vertical(modetimes(:,1), ls, main_line_colour, 2);
set(gca, 'Xlim', [t0, tf]);
xlabel('Time (s)', 'FontSize', fsize);
...
plot(tx, X(10,:), 'linestyle', ls, 'color', col);
...
plot(tx, X(11,:), 'linestyle', ls, 'color', col);
plot_vertical(modetimes(:,2:end), ls, mode_line_colour);
plot_vertical(modetimes(:,1), ls, main_line_colour, 2);
set(gca, 'Xlim', [t0, tf]);
xlabel('Time (s)', 'FontSize', fsize);
...
plot(tx, -X(12,:), 'linestyle', ls, 'color', col);
plot_vertical(modetimes(:,2:end), ls, mode_line_colour);
plot_vertical(modetimes(:,1), ls, main_line_colour, 2);
set(gca, 'Xlim', [t0, tf]);
xlabel('Time (s)', 'FontSize', fsize);
...
if (~oplot); clf; end; hold on;
plot(Eks, Eps, 'linestyle', ls, 'marker', '.', 'color', col); %Eks, Eps, [col,'x']
for k = 1:length(tx)
